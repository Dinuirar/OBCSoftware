...
#define enableChip HAL_GPIO_WritePin(ETH_CS_GPIO_Port, ETH_CS_Pin, GPIO_PIN_RESET)
#define disableChip HAL_GPIO_WritePin(ETH_CS_GPIO_Port, ETH_CS_Pin, GPIO_PIN_SET)
...
void enc28j60SetMAC(uint8_t* address) {
	enc28j60Write(MAADR0, address[0]);
	enc28j60Write(MAADR1, address[1]);
	enc28j60Write(MAADR2, address[2]);
	enc28j60Write(MAADR3, address[3]);
	enc28j60Write(MAADR4, address[4]);
	enc28j60Write(MAADR5, address[5]);
}
